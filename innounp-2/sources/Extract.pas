...
type
  ...
  protected
    ...
    function ReadProc(var Buf; Count: Longint): Longint; virtual;
    function FindSliceFilename(const ASlice: Integer): String; virtual;
  ...
  public
    ...
    procedure DecompressFile(const FL: TSetupFileLocationEntry; const DestF: TFile;
      const ProgressProc: TExtractorProgressProc; const VerifyChecksum: Boolean = false); virtual;
...
procedure TFileExtractor.DecompressFile(const FL: TSetupFileLocationEntry;
  const DestF: TFile; const ProgressProc: TExtractorProgressProc; const VerifyChecksum: Boolean);
var
  BytesLeft: Int64;
  MD5Context: TMD5Context;
  SHA1Context: TSHA1Context;
...
begin
    ...
    try
      ...
      while True do begin
        ...
        case FL.HashType of
          ...
          htSHA256: SHA256Update(SHA256Context, Buf, BufSize);
        end;
  ...
  case FL.HashType of
    ...
    htSHA256: IsHashMatch := SHA256DigestsEqual(SHA256Final(SHA256Context), FL.SHA256Sum);
  end;
