...

{
  ...
  $jrsoftware: issrc/Projects/Struct.pas,v 1.233 2009/04/07 17:37:29 mlaan Exp $
}
...
const
  ...
  SetupVersion = '5.3.0-beta '{$IFDEF ISUNICODE}+'(u)'{$ELSE}+'(a)'{$ENDIF};
  SetupBinVersion = (5 shl 24) + (3 shl 16) + (0 shl 8) + 0;
...
const
  ...
  SetupID: TSetupID = 'Inno Setup Setup Data (5.3.0)'{$IFDEF ISUNICODE}+' (u)'{$ENDIF};
