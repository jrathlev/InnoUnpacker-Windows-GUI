...
// 5.4.3 is a custom version of 5.4.2 with special version number
...
const
  ...
  SetupVersion = '5.4.3 '{$IFDEF ISUNICODE}+'(u)'{$ELSE}+'(a)'{$ENDIF};
...
const
  ...
  SetupID: TSetupID = 'Inno Setup Setup Data (5.4.3)'{$IFDEF ISUNICODE}+' (u)'{$ENDIF};
