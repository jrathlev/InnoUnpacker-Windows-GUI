### Inno Setup Unpacker 2.65.2 - Console version

#### Unpacker for installations made by Inno Setup

#### Supports Inno Setup versions 2.0.7 to 6.5.3
...
The program has also been adapted to *Inno Setup* versions 6.2 and 6.5.3.
