...

{
  ...
  $jrsoftware: issrc/Projects/Struct.pas,v 1.231 2009/03/30 19:33:07 mlaan Exp $
}
...
const
  ...
  SetupVersion = '5.2.4'{$IFDEF ISUNICODE}+'-unicode'{$ENDIF}+'-dev';
  SetupBinVersion = (5 shl 24) + (2 shl 16) + (4 shl 8) + 0;
...
const
  ...
  SetupID: TSetupID = 'Inno Setup Setup Data (5.2.5)'{$IFDEF ISUNICODE}+' (u)'{$ENDIF};
  UninstallLogID: array[Boolean] of TUninstallLogID =
    ('Inno Setup Uninstall Log (b)', 'Inno Setup Uninstall Log (b) 64-bit');
  MessagesHdrID: TMessagesHdrID = 'Inno Setup Messages ' + {$IFDEF ISUNICODE}'(5.2.5) (u)'{$ELSE}'(5.1.11)'{$ENDIF};
