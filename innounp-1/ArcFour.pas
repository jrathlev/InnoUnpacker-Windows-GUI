...
function ArcFourInitFunctions(Module: HMODULE): Boolean; stdcall;
procedure ArcFourInit(var Context: TArcFourContext; const Key;
  KeyLength: Cardinal); stdcall;
procedure ArcFourCrypt(var Context: TArcFourContext; const InBuffer;
  var OutBuffer; Length: Cardinal); stdcall;
procedure ArcFourDiscard(var Context: TArcFourContext; Bytes: Cardinal); stdcall;
